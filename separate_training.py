...
from src.datasets.data_utils_for_separate_training import get_dataloaders
from src.trainer import TrainerSeparateTraining
from src.utils.init_utils import set_random_seed, setup_saving_and_logging

warnings.filterwarnings("ignore", category=UserWarning)


@hydra.main(version_base=None, config_path="src/configs", config_name="train_in_separate_regime")
def main(config):
    """
    ...
    trainer = TrainerSeparateTraining(
        model=model,
